...
test('lib/minecraft/Unpack', () => {
    const res: Packet = { id: 0x00, data: Buffer.from([0xE0, 0x05, 0x18, 0x6D, 0x69, 0x6E, 0x65, 0x63, 0x72, 0x61, 0x66, 0x74, 0x2E, 0x6D, 0x61, 0x6B, 0x75, 0x74, 0x61, 0x6D, 0x6F, 0x74, 0x6F, 0x2E, 0x63, 0x6F, 0x6D, 0x63, 0xDD, 0x01]) };
